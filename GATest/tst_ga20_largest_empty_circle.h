#ifndef TST_GA20_LARGEST_EMPTY_CIRCLE_H
#define TST_GA20_LARGEST_EMPTY_CIRCLE_H
...
#include "ga20_largest_empty_circle/utility.h"
#include "ga20_largest_empty_circle/dcel.h"
#include "ga20_largest_empty_circle/graph.h"
#include "ga20_largest_empty_circle/delaunay.h"
#include "ga20_largest_empty_circle/voronoi.h"
#include "ga20_largest_empty_circle/convex_hull.h"
#include "ga20_largest_empty_circle/largest_empty_circle.h"
...
TEST(point, signed_area)
{
    ...
    ASSERT_TRUE(std::fabs(util::point(4.5,8).signed_area({2.8,1}, {10,3.4}) - 23.16) < 0.0001);
    ASSERT_TRUE(std::fabs(util::point(4.5,8).signed_area({10,3.4}, {2.8,1}) - (-23.16)) < 0.0001);
}
